...
public class TUGAS_Input_dan_Laporan {
    ...
    public static void main(String[] args)throws IOException{
        ...
        for(i=0;i<=data;i++){ 
            ...
            // Menampilkan semua data
                System.out.printf("| %-3s| %-28s| %-18s| %-19s| %-7s| %-19s| %-19s| %-19s| %-19s|\n"
                ,no,namaKaryawan[i],jabatanKaryawan[i],gajiPokok[i],statusKaryawan[i],tunjanganKeluarga[i],tunjanganAnak[i],pph[i],gajiBersih[i]);
            if(no%3==0){
